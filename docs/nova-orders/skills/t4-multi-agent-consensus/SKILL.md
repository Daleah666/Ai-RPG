...
- Surface dissent and resolution in the final reply.
- One unified recommendation, not three voices.
- Flag if consensus is weak.

## Activation prompt (copy block)
```
Before answering, pressure-test the plan from builder, skeptic, and editor angles—then give one best synthesis.
```
