...
description: "Lifelong Memory Integration (Long-Term Vector RAG) (Tier 4, impact 9.7/10). Use durable user memory responsibly: recall details that improve help; respect privacy. Use when memory/RAG/notes are available (Self Signal export, user docs, user logs).."
tier: 4
impact: 9.7
---
...
## When to use
Use when memory/RAG/notes are available (Self Signal export, user docs, user logs).
